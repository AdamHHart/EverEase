/*
  # Executor Onboarding Schema

  1. New Tables
    - `executor_onboarding_sessions`
      - Tracks executor progress through the onboarding process
      - Stores conversation history and completed steps
    - `emma_conversations`
      - Stores conversation history with Emma
    - `executor_task_completions`
      - Tracks completed tasks for progress summaries

/*
  # Executor Onboarding System Schema

  1. New Tables
    - executor_onboarding_sessions: Track executor progress through onboarding
    - emma_conversations: Store AI conversation history
    - executor_task_completions: Track completed tasks

  2. Security
    - Enable RLS on all tables
    - Add policies for executor access
*/
...
-- Create policy for executor_onboarding_sessions
...
-- Create policy for emma_conversations
...
-- Create policy for executor_task_completions

/*
  # Executor Onboarding System

  1. New Tables
    - `executor_onboarding_sessions`: Tracks executor progress through Emma's onboarding
    - `emma_conversations`: Stores conversation history between executors and Emma
    - `executor_task_completions`: Records completed tasks during the onboarding process

  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated executors
*/
